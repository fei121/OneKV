...
The **cross-model overview** [`../../figures/crossmodel-overview.png`](../../figures/crossmodel-overview.png)
overlays 3B (solid) vs 7B (dashed) per backend/metric; generated by `scripts/plot_crossmodel.py`.
